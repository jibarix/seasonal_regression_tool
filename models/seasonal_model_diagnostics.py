"""
Diagnostic module for seasonal time series models.
Provides tools for analyzing seasonal patterns and model components.
"""
import pandas as pd
import numpy as np
import logging
...
def create_evaluation_summary(model: Any, 
    ...
    try:
        ...
        if date_col in X_test.columns:
            ...
            from seasonal_evaluation import calculate_seasonal_error_metrics
